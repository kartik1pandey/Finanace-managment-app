    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        <div className="bg-white p-6 rounded-lg shadow-sm border">
          ...
          <p className="text-2xl font-bold text-gray-900">₹{total_value.toLocaleString()}</p>
        ...
        <div className="bg-white p-6 rounded-lg shadow-sm border">
          ...
          <p className="text-2xl font-bold text-blue-600">₹{total_investment.toLocaleString()}</p>
        ...
        <div className="bg-white p-6 rounded-lg shadow-sm border">
          ...
          <p className={`text-2xl font-bold ${total_return >= 0 ? 'text-green-600' : 'text-red-600'}`}>
        ...
        <div className="bg-white p-6 rounded-lg shadow-sm border">
          <h3 className="text-sm font-medium text-gray-600 mb-2">CAGR</h3>
        ...
        <div className="bg-white p-6 rounded-lg shadow-sm border">
          ...
          <div className="space-y-4">
            <div className="p-4 bg-green-50 border border-green-200 rounded-lg">
              ...
              <p className="text-sm text-green-700 mt-1">RELIANCE.NS</p>
            </div>
            ...
            <div className="p-4 bg-red-50 border border-red-200 rounded-lg">
              ...
              <p className="text-sm text-red-700 mt-1">TCS.NS</p>
            </div>
            ...
            <div className="p-4 bg-blue-50 border border-blue-200 rounded-lg">
              ...
              <p className="text-sm text-blue-700 mt-1">Well-diversified portfolio</p>
            </div>
            
            <div className="p-4 bg-purple-50 border border-purple-200 rounded-lg">
              <div className="flex items-center justify-between">
                <span className="font-medium text-purple-800">Market Beat</span>
                <span className="font-bold text-purple-600">+4.7%</span>
              </div>
              <p className="text-sm text-purple-700 mt-1">Outperforming Nifty 50</p>
            </div>
          </div>
        </div>
      </div>
